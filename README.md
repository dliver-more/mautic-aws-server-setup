...
### Email Settings
- **EMAIL_FROM_EMAIL** (Optional):  
  Default "from" email address for emails sent by Mautic.  
  Example: `no-reply@example.com`

- **EMAIL_FROM_NAME** (Optional):  
  Default "from" name for emails sent by Mautic.  
...
- **PHP_VERSION** (Required):  
  Version of PHP to use. Defaults to `8.2`.
